    ...
    <div className='bg-white w-full flex justify-center items-center mt-20'>
        <div className='w-[95%] bg-[#fee7ed] rounded-xl flex md:py-10 '>
            <div className='md:w-2/5 w-full md:p-[45px] p-8'>
                ...
                <p className='text-[15px] font-serif md:mt-5 mt-4'>At Web Logic Labs, experience seamless designs, unmatched creativity, and exceptional service.
            ...
            <div className='w-3/5 relative md:block hidden'>
                ...
                <div className='flex bg-white w-[60%] p-4 rounded-[14px] absolute top-[-30%] right-[10%] shadow-md z-1'>
                  <div className='w-1/3'>
