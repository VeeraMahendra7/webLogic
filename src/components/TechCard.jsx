...
const TechCard = ({detail}) => {
  return (
    <div className='md:my-20 solid border bg-[#f9f9fa] hover:bg-[#c4e8fb] h-[350px] w-[280px] rounded-[8px] p-5 flex flex-col justify-center items-center shadow-xl hover:scale-105 cursor-pointer z-[-10]'>
        <div className='h-1/2'>
